	...
	if(isset($_GET['apicall'])){
		...
		switch($_GET['apicall']){
			...
			case 'createpos':
				...
				isTheseParametersAvailable(array('fullname','age','gender','course','company'));
			...
			case 'updatepos':
				isTheseParametersAvailable(array('p_id','fullname','age','gender','course','company'));
				$db = new DbOperation();
			...
			case 'getsalebyid':
				isTheseParametersAvailable(array('p_id'));
				$db = new DbOperation();
